                ...
                >
                  ...
                  <template v-slot:cell(dibayar)="data">
                    ...
                    >
                      <option
                        value="belum_dibayar"
                        :selected="data.item.belum_dibayar === 'belum_dibayar'"
                      >
                        Belum Dibayar
                      </option>
                      <option
                  ...
                  <template v-slot:cell(Aksi)="data">
                    <b-button
                      ...
                      v-on:click="Detail(data.item, data.item.total)"
    ...
    >
      <div class="table-responsive table table-stripped" id="print">
        <table class="table table-bordered table-responsive">
          <tr>
            <td rowspan="3">
              <img src="src/assets/img/2150.jpg" width="150" />
            </td>
            <td>ID ORDER</td>
            <td>:</td>
        ...
        <hr />
        <br />
        <b-table striped hover :items="detail_transaksi.detail_transaksi">
        </b-table>
